...
import Earthpit_component from "./components/Earthpit_component";
import { IconDownload } from "@tabler/icons-react";

const MAPBOX_TOKEN =
  "pk.eyJ1Ijoic2tpcm8iLCJhIjoiY2w1aTZjN2x2MDI3ODNkcHp0cnhuZzVicSJ9.HMjwHtHf_ttkh_aImSX-oQ";

const Submit_success = ({ setShowSubmitSuccess, setShowEarthpitSuccess }) => {
  ...
  const handleClick = () => {
    ...
    console.log("Soil Seristivity", soil_rsistivity);
