...
const SubmitSuccess = ({ setShowSubmitSuccess }) => {
  const soil_rsistivity = window.localStorage.getItem("soil");

  const ion = window.localStorage.getItem("ion");
  ...
  const handleGeneratePDF = () => {
    ...
    doc.save("Smart_Earthing_report.pdf");
  };
    ...
    <div>
      ...
      <Grid>
        ...
        <Grid.Col md={2} lg={5}>
          ...
          >
            <thead>
              <tr>
                ...
                <th style={{ width: "20%" }}>Ion Gradient : {ion}</th>
              </tr>
            </thead>
          </Table>
          ...
          >
            <thead>
              <tr>
                ...
                <th style={{ width: "33%", fontWeight: "bold" }}>Associate</th>
              </tr>
            </thead>
          ...
          <Text mt="xl" color="red" fw="bold">
            *All values are predicted using AI according to NBSS and IEEE
            standards.{" "}
          </Text>
        </Grid.Col>
