...
const ProgressBar = ({ data, value, env, diac, temp, pressure, humidity }) => {
  ...
  return (
    <Card shadow="sm" padding="lg" radius="md" withBorder mt="md">
      <Text fz="xl" ta="center" fw="bold" mb="xs">
        Live Warning
      </Text>
      <Card.Section withBorder inheritPadding py="xs">
        <Grid>
          <Grid.Col md={4} lg={6} mt="1px" mb="xs">
          ...
          <Grid.Col md={4} lg={4} mt="1px" mb="xl">
            <FieldValues data={diac} color="yellow" title="Electro-Static" />
            <FieldValues data={value} color="green" title="Spark" />
            <FieldValues data={env} color="blue" title="Environment" />
          </Grid.Col>
